                              ...
                              <div className="flex">
                                ...
                                <div className="ml-3">
                                  <p className="text-sm text-yellow-700">
                                    <span className="font-semibold">{gamesNeedingScores.length} game{gamesNeedingScores.length !== 1 ? 's' : ''}</span> still need{gamesNeedingScores.length === 1 ? 's' : ''} scores to be complete. Click "Add Score" to add scores.
                                  </p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex-1">
                              ...
                              {game.home_score === null && (
                                <div className="mt-2 text-sm text-yellow-800 font-medium flex items-center gap-1">
                                  ...
                                  Action Required: Click "Add Score" to enter final score
                                </div>
                              )}
                            </div>
